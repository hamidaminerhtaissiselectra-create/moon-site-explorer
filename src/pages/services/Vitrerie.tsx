...
import { GlassWater, CheckCircle2, ArrowRight, Phone, ChevronRight, AlertTriangle, ShieldCheck, Clock, Zap, Shield } from "lucide-react";
...
const VitreriePage = () => {
  ...
  return (
    <main className="relative">
      ...
      <FAQSection />
      <ExpertiseSection 
        image="/images/expertise-vitrerie.jpg"
        title="Expertise Technique & Savoir-Faire en Vitrerie"
        description="Le remplacement d'un vitrage demande une précision millimétrée et une connaissance approfondie des matériaux. Nos vitriers experts maîtrisent la pose de tous types de verres : du double vitrage thermique haute performance au verre feuilleté de sécurité. Nous intervenons avec un équipement professionnel pour garantir une installation sûr, étanche et durable."
        points={[
          "Remplacement de tous types de vitrages (simple, double, triple)",
          "Mise en sécurité immédiate après bris de glace",
          "Vitrages certifiés conformes aux normes d'isolation et sécurité",
          "Garantie 2 ans sur tous les vitrages posés"
        ]}
      />
      <TestimonialsSection />
