...
const ReparationVoletsPage = () => {
  ...
  return (
    <main className="relative">
      ...
      <FAQSection />
      <ExpertiseSection 
        image="/images/expertise-reparation.jpg"
        title="Expertise Technique & Savoir-Faire en Réparation"
        description="Nos techniciens certifiés maîtrisent tous les types de pannes de volets roulants, des blocages mécaniques aux pannes moteur en passant par les dommages structurels. Avec un diagnostic précis et des pièces d'origine, nous réparons votre volet en une seule visite dans 95% des cas, vous redonnant sécurité et confort."
        points={[
          "Diagnostic gratuit et sans engagement",
          "Pièces de rechange d'origine en stock",
          "Réparation en une seule visite (95% des cas)",
