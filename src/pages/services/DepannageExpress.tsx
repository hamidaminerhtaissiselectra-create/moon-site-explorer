...
const DepannageExpressPage = () => {
  ...
  return (
    <main className="relative">
      ...
      <FAQSection />
      <ExpertiseSection 
        image="/images/technicien-expertise.jpg"
        title="Expertise Technique & Savoir-Faire en Dépannage"
        description="Nos techniciens certifiés disposent d'une expertise pointue dans la réparation d'urgence de tous types de volets roulants. Qu'il s'agisse d'un blocage mécanique, d'une panne moteur ou d'un tablier endommagé, ils interviennent avec professionnalisme et précision pour diagnostiquer et résoudre votre problème lors d'une visite unique dans 95% des cas."
        points={[
          "Diagnostic technique approfondi et gratuit",
          "Pièces de rechange d'origine certifiées en stock",
          "Intervention express : Paris & Île-de-France",
