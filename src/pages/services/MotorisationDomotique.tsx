...
const MotorisationDomotiquePage = () => {
  ...
  return (
    <main className="relative">
      ...
      <FAQSection />
      <ExpertiseSection 
        image="/images/expertise-motorisation.jpg"
        title="Expertise Technique & Savoir-Faire en Motorisation"
        description="La motorisation d'un volet roulant demande une expertise pointue pour sélectionner le moteur adapté au poids du tablier et au diamètre de l'axe. Nos techniciens maîtrisent les solutions Somfy (RTS, io-homecontrol) et Bubendorff. Nous garantissons une installation propre, une configuration domotique optimale et une formation complète pour exploiter toutes les fonctionnalités de votre système."
        points={[
          "Diagnostic de compatibilité de vos volets",
          "Installation de moteurs silencieux et performants",
          "Configuration domotique et appairage smartphone",
          "Garantie 2 ans moteur et installation"
        ]}
      />
      <TestimonialsSection />
