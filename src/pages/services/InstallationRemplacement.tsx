...
const InstallationRemplacementPage = () => {
  ...
  return (
    <main className="relative">
      ...
      <FAQSection />
      <ExpertiseSection 
        image="/images/expertise-installation.jpg"
        title="Expertise Technique & Savoir-Faire en Installation"
        description="Nos techniciens certifiés maîtrisent l'installation de tous types de volets roulants, qu'ils soient en aluminium, PVC ou solaires. Avec des mesures laser de précision et une pose méthodique, nous garantissons une installation sans défaut, une isolation optimale et un fonctionnement silencieux pour des décennies."
        points={[
          "Mesures laser pour un sur-mesure parfait",
          "Installation sans dégradation de vos façades",
          "Réglage précis des fins de course et moteurs",
