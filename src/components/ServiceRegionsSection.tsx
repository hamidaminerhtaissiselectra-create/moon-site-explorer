                ...
                <Link to={r.link} className="flex flex-col h-full">
                  ...
                  <div className={`flex-1 p-5 rounded-b-2xl border border-t-0 transition-all duration-500 card-shadow group-hover:card-shadow-hover ${r.color}`}>
                    <div className="flex items-center gap-3 mb-3">
                      <div className={`w-8 h-8 rounded-lg flex items-center justify-center shadow-sm border border-white/20 ${r.highlight ? "bg-service-blue text-white" : "bg-white/80 text-muted-foreground"}`}>
                         <MapPin className="h-4 w-4" />
                      </div>
                      <h3 className={`text-base font-bold ${r.highlight ? "text-service-blue" : "text-foreground"}`}>
                        {r.name}
                      </h3>
                    </div>
